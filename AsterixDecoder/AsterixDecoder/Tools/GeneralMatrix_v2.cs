...
using CholeskyDecomposition = Accord.Math.Decompositions.CholeskyDecomposition;
...
namespace DotNetMatrix
{
    ...
    public class GeneralMatrix : System.ICloneable, System.Runtime.Serialization.ISerializable, System.IDisposable
    {
        ...
        {
            return new SingularValueDecomposition(Magia(this)).TwoNorm;
        }
        ...
        {
            return new LUDecomposition(Magia(this));
        }
        ...
        {
            return new QRDecomposition(Magia(this));
        }
        ...
        {
            return new CholeskyDecomposition(Magia(this));
        }
        ...
        {
            return new SingularValueDecomposition(Magia(this));
        }
        ...
        {
            return new EigenvalueDecomposition(Magia(this));
        }
        ...
        {
            return (m == n ? MagiaInversa(new LUDecomposition(Magia(this)).Solve(Magia(B)), m, n) : MagiaInversa(new QRDecomposition(Magia(this)).Solve(Magia(B)), m, n));
        }
        ...
        {
            return new LUDecomposition(Magia(this)).Determinant;
        }
        ...
        {
            return new SingularValueDecomposition(Magia(this)).Rank;
        }
        ...
        {
            return new SingularValueDecomposition(Magia(this)).Condition;
        }
        ...
        private double[,] Magia(GeneralMatrix B)
        {
            double[,] Matrix = new double[B.m, B.n];
        ...
        private GeneralMatrix MagiaInversa(double[,] Matrix, int m, int n)
        {
            GeneralMatrix B = new GeneralMatrix(m, n);
